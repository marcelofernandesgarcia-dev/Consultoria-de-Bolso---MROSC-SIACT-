...
const PHASES = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { text: 'Autocomplete de material/serviço na Cotação Prévia via catálogo oficial (CATMAT/CATSER, Compras.gov.br) — sincroniza PDMs de material e itens de serviço localmente, já que a API pública não aceita busca por texto livre', done: true, dificuldade: 'media' as Dificuldade },
      { text: 'Sugerir valor de referência na Cotação Prévia via API de Pesquisa de Preços do Compras.gov.br (dadosabertos.compras.gov.br/modulo-pesquisa-preco) — mediana de compras públicas reais dos últimos 12 meses, calculada ao vivo a partir do item selecionado no catálogo', done: true, dificuldade: 'baixa' as Dificuldade },
      { text: 'Reforçar o catálogo de preços com uma rotina de resync periódico (o PDM/serviço muda pouco, mas convém manter atualizado)', done: false, dificuldade: 'baixa' as Dificuldade },
