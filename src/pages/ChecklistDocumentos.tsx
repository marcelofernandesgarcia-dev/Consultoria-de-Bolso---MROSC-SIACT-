...
const CHECKLISTS: Record<string, ItemChecklist[]> = {
  chamamento: [
    { id: 'c1', descricao: 'Cópia do estatuto social registrado em cartório', fundamento: 'Art. 34, III, Lei 13.019/2014', obrigatorio: true, dica: 'O estatuto deve conter a finalidade compatível com o objeto do chamamento.' },
    { id: 'c2', descricao: 'Ata de eleição da diretoria vigente', fundamento: 'Art. 34, V, Lei 13.019/2014', obrigatorio: true },
    { id: 'c3', descricao: 'CNPJ ativo e compatível com o objeto', fundamento: 'Art. 34, VII, Lei 13.019/2014', obrigatorio: true, dica: 'O CNAE deve ser compatível com a atividade da parceria.' },
    { id: 'c4', descricao: 'Certidão Negativa de Débitos Trabalhistas (CNDT)', fundamento: 'Art. 34, II, Lei 13.019/2014', obrigatorio: true },
    { id: 'c5', descricao: 'Certidão de regularidade fiscal federal (CND)', fundamento: 'Art. 34, II, Lei 13.019/2014', obrigatorio: true },
    { id: 'c6', descricao: 'Certidão de regularidade fiscal estadual e municipal', fundamento: 'Art. 34, II, Lei 13.019/2014', obrigatorio: true },
    { id: 'c7', descricao: 'Comprovante de tempo mínimo de existência (1/2/3 anos conforme Município/Estado-DF/União)', fundamento: 'Art. 33, V, "a", Lei 13.019/2014', obrigatorio: true, dica: 'Data de abertura registrada no cartão CNPJ ou certidão de registro.' },
    { id: 'c8', descricao: 'Experiência prévia na realização do objeto (conforme edital)', fundamento: 'Art. 33, V, "b", Lei 13.019/2014', obrigatorio: false, dica: 'Apresentar relatórios de projetos anteriores similares.' },
  ...
  celebracao: [
    ...
    { id: 'cel5', descricao: 'Certidões negativas atualizadas (federais, estaduais, municipais)', fundamento: 'Art. 34, II, Lei 13.019/2014', obrigatorio: true },
    { id: 'cel6', descricao: 'Designação formal do gestor da parceria', fundamento: 'Art. 35, V, "g", Lei 13.019/2014', obrigatorio: true, dica: 'Responsabilidade do órgão público — verificar se já foi designado.' },
  ],
  execucao: [
    { id: 'ex1', descricao: 'Notas fiscais de todas as despesas realizadas', fundamento: 'Art. 64, Lei 13.019/2014', obrigatorio: true, dica: 'Guardar original físico e digitalizar para o sistema.' },
    { id: 'ex2', descricao: 'Extratos bancários mensais da conta da parceria', fundamento: 'Art. 51, Lei 13.019/2014', obrigatorio: true },
    { id: 'ex3', descricao: 'Comprovação de compatibilidade dos preços com o mercado', fundamento: 'Art. 46, Lei 13.019/2014; Decreto 8.726/2016, Art. 25, §1º', obrigatorio: true, dica: 'Não há valor fixo que obrigue cotação — qualquer um dos 11 métodos aceitos serve (cotação com 3 fornecedores é só um deles).' },
    ...
    { id: 'ex5', descricao: 'Relatório de execução das atividades (mensal ou conforme plano)', fundamento: 'Art. 66, I, Lei 13.019/2014', obrigatorio: true },
    { id: 'ex6', descricao: 'Comprovante de aplicação dos rendimentos (quando houver)', fundamento: 'Art. 51, parágrafo único, Lei 13.019/2014', obrigatorio: false },
  ...
  prestacao: [
    { id: 'pc1', descricao: 'Relatório de execução do objeto (resultados x metas)', fundamento: 'Art. 66, I, Lei 13.019/2014', obrigatorio: true, dica: 'Compare cada meta prevista no Plano de Trabalho com o resultado alcançado.' },
    { id: 'pc2', descricao: 'Relatório de execução financeira (receitas x despesas)', fundamento: 'Art. 66, II, Lei 13.019/2014', obrigatorio: true },
