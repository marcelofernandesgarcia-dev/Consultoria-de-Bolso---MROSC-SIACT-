                  ...
                  <div className="px-4 py-3 flex items-center justify-between"
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500 mt-0.5">
                        {ativos.length > 0 ? `${ativos.length} aviso${ativos.length > 1 ? 's' : ''} ativo${ativos.length > 1 ? 's' : ''}` : 'Tudo em dia'}
                      </p>
                    </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center justify-between mt-2">
                              ...
                              <button onClick={() => dismiss(a.id)} className="text-[10px] text-slate-400 hover:text-slate-600 transition-colors">
                                Dispensar
                              </button>
                            </div>
                          </div>
